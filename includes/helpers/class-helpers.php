...
class HCFW_Helpers
{
     ...
     */
    public static function get_link_from_cookie()
    {
     ...
     */
    public static function insert_or_update_link($link_name, $link_hash, $products, $created_by, $free_shipping = false, $logged_in_only = false, $use_once = false)
    {
        global $wpdb;
     ...
     */
    public static function toggle_link_status($link_hash, $status)
    {
        global $wpdb;
        $table_links = $wpdb->prefix . "hcfw_links";
     ...
     */
    public static function get_link_info($link_hash)
    {
        global $wpdb;
        $table_links = $wpdb->prefix . "hcfw_links";
        $table_config = $wpdb->prefix . "hcfw_link_metadata";
     ...
     */
    public static function update_link_use_count($link_hash)
    {
        global $wpdb;
        $table_links = $wpdb->prefix . "hcfw_links";
     ...
     */
    public static function soft_delete_link($link_hash)
    {
        global $wpdb;
        $table_links = $wpdb->prefix . "hcfw_links";
    ...
    public static function get_metadata($link_hash, $meta_key, $default = null)
    {
        global $wpdb;
        $table_config = $wpdb->prefix . "hcfw_link_metadata";
        $table_links = $wpdb->prefix . "hcfw_links";
    ...
    public static function get_product_discount($link_hash, $product_id, $default = 0)
    {
        global $wpdb;
        $table_products = $wpdb->prefix . "hcfw_link_products";
        $table_links = $wpdb->prefix . "hcfw_links";
    ...
    public static function transformArray($inputArray)
    {
        $result = [];
        $temp = [];
